...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2018 at 08:18 PM
...
INSERT INTO `plants` (`name`, `product_id`, `height`, `width`, `light`, `water`, `plant_type`, `life`) VALUES
('MariGold', 1, 8, 5, 'Full', '1 to 2 days', 'flower', 'seasonal'),
('Rose', 2, 9, 7, 'Full', '2 to 3 days', 'flower', 'annual'),
('Purple Shamrock', 3, 5, 8, 'Partial', '6 to 7 days', 'leafy plant', 'evergreen');
...
INSERT INTO `product` (`product-id`, `Name`, `Photo`, `category_id`, `Unit_price`, `created_at`, `updated_at`) VALUES
(1, 'Mari Gold', 'C:\\xampp\\htdocs\\Peach\\public\\Marigold.jpg', 1, 80, '2018-04-29 19:00:00', NULL),
(2, 'Red Rose', 'C:\\xampp\\htdocs\\Peach\\public\\Rose.jpg', 1, 120, '2018-04-29 19:00:00', NULL),
(3, 'Purple Shamrock', 'C:\\xampp\\htdocs\\Peach\\public\\PurpleShamrock.jpg', 1, 200, '2018-04-29 19:00:00', NULL);
...
ALTER TABLE `product`
  ...
  ADD UNIQUE KEY `product_product_id_unique` (`product-id`);
...
--
ALTER TABLE `product`
  MODIFY `product-id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
